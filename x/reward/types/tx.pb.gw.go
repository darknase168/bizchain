...
var (
	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"bizchain", "reward", "balance", "jamaah"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Reward_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"bizchain", "reward", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RewardAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1}, []string{"bizchain", "reward"}, "", runtime.AssumeColonVerbOpt(false)))
)
